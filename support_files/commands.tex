...
\patchcmd{\abstracttwo}{\abstractname}{\abstracttwoname}{}{}
\newcommand{\abstracttwoname}{Sammendrag}


\definecolor{MaxCyan}{rgb}{0,0.568627451,0.8235294118} % RGB values for orange (R=1, G=0.5, B=0)
\definecolor{MaxCyan2}{rgb}{0.0, 0.72, 0.92}
\definecolor{MaxCyan3}{cmyk}{1,0,0,0}
\definecolor{MaxOrange}{rgb}{1.0, 0.5, 0.0}
\definecolor{MaxOrange2}{rgb}{1.0, 0.5, 0.0}
