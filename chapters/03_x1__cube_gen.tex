...
Keller's \namecref{thrm:keller_tiling} is one of the main aims of the \namecref{chap:tiling} and will later be proven in \cref{sec:proof_keller}. Furthermore, we highlight that Keller's \namecref{thrm:keller_tiling} is essential for classifying tiling sets. However, the proof of the two-dimensional case is postponed to \cref{chap:equivalence} due to the connections with spectra which have not yet been covered.
%* ———————————————————————————— One dimension  ——————————————————
