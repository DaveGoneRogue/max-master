...
\colorbox{BurntOrange}{Transition text here?} %! %Of all the $L^p$ spaces, the case $p=2$ is special since $L^2(E)$ is the only space whose norm
...
\colorbox{BurntOrange}{Transition text here?} %! Synes det trengs overgang her
%* —————————————————————————————————————— C Cont. FUNCTIONS ——————————————————————————————————————
Let
