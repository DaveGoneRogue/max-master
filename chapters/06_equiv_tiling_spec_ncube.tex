...
\begin{theorem}\label{thrm:periodic_equivalence}
    ...
    \begin{enumerate}[label=(\roman*), topsep=-3pt]
        ...
        \item $\bral{K} = \bral{\det(M)}$ \textsc{and} $L+\brac{K-K}\subseteq \Zstroke_{I^d} \cup \braq{0}$  \SigridChange{This dont make sense. Can I write it as $\Lambda-\Lambda \subseteq$, or show in the remark that it is equivalent to what we have seen?}
    \end{enumerate}
\end{theorem}
