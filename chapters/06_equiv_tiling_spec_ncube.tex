...
\SigridComment{Equvalent restatement of kellers theorem in terms of zero set.}
\textcolor{orange}{  %! Here
Recall \cref{thrm:keller_tiling}, Keller's theorem. We have an equivalent version of the \namecref{thrm:keller_tiling} similar to \cref{lem:zero_set_AiSp}, in which by observing the connection in the wording of the proof of \cref{lem:zero_set_orthoganl_general,lem:zero_set_jp_1_5} with the wording in the \namecref{thrm:keller_tiling}.
\begin{theorem}[Keller's theorem alternative]\label{thrm:keller_alternative}
    ...
    \end{equation*} 
\end{theorem}
\cref{lem:zero_set_orthoganl_general}
} %! Here
\textcolor{orange}{  %! Here
The following \namecref{cor:tiling_pair_implies_orthogonal} follows directly from Keller's theorem, \cref{thrm:keller_alternative}, and \cref{lem:zero_set_AiSp}.
