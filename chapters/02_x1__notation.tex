...
\begin{proof}\cite[p.~228]{heilMetricsNormsInner2018}
    Let $f \in C[0,1]$, $\delta = \varepsilon^2/(8\|f\|_\infty)$, and construct $g$ such that $g\in \Cper$ in the following way %We will construct a function $g$ that belongs to $C_{\text{per}}[0,1]$. Let  $\delta = \varepsilon^2/(8\|f\|_\infty)$, and $g$  be given by
%\begin{equation*}
