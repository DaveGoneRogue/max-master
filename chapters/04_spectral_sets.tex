...
\begin{proof}
    ...
    \end{align*}
    This shows that $E(\Lambda_\alpha)$ is orthogonal since $\Lambda$ is orthogonal. Now, to show completeness assume that $f\in L^2(\Omega)$ satisfies $\braaMed{f,e_{\lambda + \alpha}} = 0$ for all $\lambda\in \Lambda_\alpha$, and observe that
    \begin{align*}
