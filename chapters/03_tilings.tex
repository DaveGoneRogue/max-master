...
If we now restrict our attention to \SigridChange{tilings of the unit cube in $R^d$}, Keller's theorem immediately gives the following for dimension one.  For $d=1$, the unit cube is simply the unit interval $I = \bras{0,1}$. %In dimension one, the unit cube is simply the unit interval $I = \bras{0,1}$. 
